 ...
 * @package subsites
 */
class CopyMoveSubsitesTreeDropdownField extends TreeDropdownField {
	
	protected $subsiteID = 0;
	
	protected $extraClasses = array('CopyMoveSubsitesTreeDropdownField');
	
	function Field() {
		$html = parent::Field();
		
		Requirements::javascript('subsites/javascript/CopyMoveSubsitesTreeDropdownField.js');
